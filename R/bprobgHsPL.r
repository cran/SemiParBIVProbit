bprobgHsPL <- function(params, BivD, nC, nu, xi1, xi2, PL, eqPL, H.n, y1.y2, y1.cy2, cy1.y2, cy1.cy2, cy1, X1, X2, weights=weights, X1.d2, X2.d2, pPen1=NULL, pPen2=NULL, sp=NULL, qu.mag=NULL, gp1, gp2, fp, l.sp1, l.sp2, K=NULL, n=NULL, N=NULL, cuid=NULL, uidf=NULL, masses=NULL, NGQ=NULL, dat1all=NULL, dat2all=NULL, W=NULL){
...
#, sum(d2l.rho.lambda1), sum(d2l.rho.lambda2) ),
...
# , sum( dl.dlambda1.st ), sum( dl.dlambda2.st )    )
#
#}
#
#if(eqPL=="first"){  
