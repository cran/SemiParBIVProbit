...
if(x$gamlssfit == FALSE && type == "univariate" && x$margins[2] %in% m2) stop("You need to fit the univariate model to obtain the OR. Refit the model and set gamlssfit = TRUE.")
