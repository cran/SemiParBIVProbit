g.triSS <- function(params, respvec, VC, TIn){
  ...
  p.1.11  <- mm(pbinorm( TIn$eta2[VC$inde2.1],  TIn$eta3, mean1 =   mean1[VC$inde2], mean2 =   mean2[VC$inde2], var1 = var1, var2 = var2, cov12 =   cov1) )            
  p.1.10  <- mm(pbinorm( TIn$eta2[VC$inde2.1], -TIn$eta3, mean1 =   mean1[VC$inde2], mean2 =  -mean2[VC$inde2], var1 = var1, var2 = var2, cov12 =  -cov1) ) 
  
  p.2.11  <- mm(pbinorm( TIn$eta1[VC$inde2],   TIn$eta3, mean1 =   mean3[VC$inde2.1], mean2 =   mean4[VC$inde2.1], var1 = var1, var2 = var3, cov12 =   cov2) )
  p.2.10  <- mm(pbinorm( TIn$eta1[VC$inde2],  -TIn$eta3, mean1 =   mean3[VC$inde2.1], mean2 =  -mean4[VC$inde2.1], var1 = var1, var2 = var3, cov12 =  -cov2) )
  
  p.3.11  <- mm(pbinorm( TIn$eta1[VC$inde2],   TIn$eta2[VC$inde2.1], mean1 =   mean5, mean2 =   mean6, var1 = var2, var2 = var3, cov12 =   cov3) )
  p.3.10  <- mm(pbinorm( TIn$eta1[VC$inde2],  -TIn$eta2[VC$inde2.1], mean1 =   mean5, mean2 =  -mean6, var1 = var2, var2 = var3, cov12 =  -cov3) ) 
  
  upst.1   <- mm( pnorm( (TIn$eta2            - TIn$theta12 * TIn$eta1[VC$inde1])/sqrt(1 - TIn$theta12^2)) )
  upst.2   <- mm( pnorm( (TIn$eta1[VC$inde1]  - TIn$theta12 * TIn$eta2          )/sqrt(1 - TIn$theta12^2)) )
  
  dl.de1.1           <- - respvec$cy1/TIn$p0 * d.1
  dl.de1.1[VC$inde1] <-   respvec$y1.cy2/TIn$p10 * (d.1[VC$inde1] - d.1[VC$inde1] * upst.1) 
  dl.de1.1[VC$inde2] <-   respvec$y1.y2.cy3/TIn$p110 * d.1[VC$inde2] * p.1.10 + 
    respvec$y1.y2.y3/TIn$p111  * d.1[VC$inde2] * p.1.11 
  dl.de1 <- dl.de1.1
  
  
  dl.de2.1             <- - respvec$y1.cy2/TIn$p10 * d.2 * upst.2
  dl.de2.1[VC$inde2.1] <-   respvec$y1.y2.cy3/TIn$p110   * d.2[VC$inde2.1] * p.2.10 +
  ...
  mean.12 <- ( TIn$eta1[VC$inde1] * (TIn$theta13 - TIn$theta12 * TIn$theta23) + TIn$eta2 * (TIn$theta23 - TIn$theta12 * TIn$theta13) )/( 1 - TIn$theta12^2 )
  mean.13 <- ( TIn$eta1[VC$inde2] * (TIn$theta12 - TIn$theta13 * TIn$theta23) + TIn$eta3 * (TIn$theta23 - TIn$theta12 * TIn$theta13) )/( 1 - TIn$theta13^2 )
  mean.23 <- ( TIn$eta2[VC$inde2.1] * (TIn$theta12 - TIn$theta13 * TIn$theta23) + TIn$eta3 * (TIn$theta13 - TIn$theta12 * TIn$theta23) )/( 1 - TIn$theta23^2 )
  ...
  p12.g <- probm( (TIn$eta3          - mean.12[VC$inde2.1])/sd.12, "probit")$pr
  p13.g <- probm( (TIn$eta2[VC$inde2.1] - mean.13)/sd.13, "probit")$pr
  p23.g <- probm( (TIn$eta1[VC$inde2]   - mean.23)/sd.23, "probit")$pr
  ...
  d11.12 <- dbinorm( TIn$eta1[VC$inde1],      TIn$eta2, cov12 =  TIn$theta12)
  d11.13 <- dbinorm( TIn$eta1[VC$inde2],   TIn$eta3, cov12 =  TIn$theta13)
  d11.23 <- dbinorm( TIn$eta2[VC$inde2.1], TIn$eta3, cov12 =  TIn$theta23)
