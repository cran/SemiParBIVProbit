extraiterNP <- function(paramNP, y1, y2, q1, q2, y1.y2, y1.cy2, cy1.y2, cy1.cy2, cy1, X1, X2, X1.d2, X2.d2, sp, qu.mag=NULL, gp1, gp2, fp, l.sp1, l.sp2, weights, 
        ...
        T.sv <- bprobNP(paramNP, y1=y1, y2=y2, 
                         ...
                         X1=X1, X2=X2,  
                         X1.d2=X1.d2, X2.d2=X2.d2, sp=sp, qu.mag=qu.mag, gp1=gp1, gp2=gp2, fp=fp, l.sp1=l.sp1, l.sp2=l.sp2, weights=weights, 
