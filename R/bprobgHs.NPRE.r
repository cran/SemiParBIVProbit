bprobgHs.NPRE <- function(params, BivD, nC, nu, gev.eq1, gev.eq2, shape1, shape2, H.n=NULL, y1.y2, y1.cy2, cy1.y2, cy1.cy2, cy1, X1, X2, weights=weights, X1.d2, X2.d2, pPen1=NULL, pPen2=NULL, sp=NULL, qu.mag=NULL, gp1, gp2, fp, l.sp1, l.sp2, K, n, N, cuid, uidf, masses, NGQ=NULL, dat1all=NULL, dat2all=NULL, W=NULL){
...
if( ( l.sp1==0 && l.sp2==0 ) || fp==TRUE) S.h <- S.h1 <- S.h2 <- 0
   ...
   S.h2 <- S.h%*%params
         ...
         list(value=res, gradient=G, hessian=H, S.h=S.h, l=S.res, masses=masses,
              ...
              d2l.be2.rho=d2l.be2.rho, d2l.rho.rho=d2l.rho.rho, We=We, good=good)
