g.tri <- function(respvec, VC, TIn){
  ...
  p.1.11  <- mm(pbinorm( TIn$mar2,   TIn$mar3, mean1 =   mean1, mean2 =   mean2, var1 = var1, var2 = var2, cov12 =   cov1) )            
  p.1.10  <- mm(pbinorm( TIn$mar2,  -TIn$mar3, mean1 =   mean1, mean2 =  -mean2, var1 = var1, var2 = var2, cov12 =  -cov1) ) 
  p.1.00  <- mm(pbinorm(-TIn$mar2,  -TIn$mar3, mean1 =  -mean1, mean2 =  -mean2, var1 = var1, var2 = var2, cov12 =   cov1) ) 
  p.1.01  <- mm(pbinorm(-TIn$mar2,   TIn$mar3, mean1 =  -mean1, mean2 =   mean2, var1 = var1, var2 = var2, cov12 =  -cov1) )
  
  p.2.11  <- mm(pbinorm( TIn$mar1,   TIn$mar3, mean1 =   mean3, mean2 =   mean4, var1 = var1, var2 = var3, cov12 =   cov2) )
  p.2.10  <- mm(pbinorm( TIn$mar1,  -TIn$mar3, mean1 =   mean3, mean2 =  -mean4, var1 = var1, var2 = var3, cov12 =  -cov2) )
  p.2.00  <- mm(pbinorm(-TIn$mar1,  -TIn$mar3, mean1 =  -mean3, mean2 =  -mean4, var1 = var1, var2 = var3, cov12 =   cov2) )
  p.2.01  <- mm(pbinorm(-TIn$mar1,   TIn$mar3, mean1 =  -mean3, mean2 =   mean4, var1 = var1, var2 = var3, cov12 =  -cov2) )
  
  p.3.11  <- mm(pbinorm( TIn$mar1,   TIn$mar2, mean1 =   mean5, mean2 =   mean6, var1 = var2, var2 = var3, cov12 =   cov3) )
  p.3.10  <- mm(pbinorm( TIn$mar1,  -TIn$mar2, mean1 =   mean5, mean2 =  -mean6, var1 = var2, var2 = var3, cov12 =  -cov3) ) 
  p.3.00  <- mm(pbinorm(-TIn$mar1,  -TIn$mar2, mean1 =  -mean5, mean2 =  -mean6, var1 = var2, var2 = var3, cov12 =   cov3) ) 
  p.3.01  <- mm(pbinorm(-TIn$mar1,   TIn$mar2, mean1 =  -mean5, mean2 =   mean6, var1 = var2, var2 = var3, cov12 =  -cov3) ) 
  ...
  dl.dF1 <- respvec$y1.y2.y3/TIn$p111 * d.1 * p.1.11 +
    respvec$y1.y2.cy3/TIn$p110 * d.1 * p.1.10 -
    respvec$cy1.y2.y3/TIn$p011 * d.1 * p.1.11 -
    respvec$cy1.y2.cy3/TIn$p010 * d.1 * p.1.10 -
    respvec$cy1.cy2.cy3/TIn$p000 * d.1 * p.1.00 -
    respvec$cy1.cy2.y3/TIn$p001 * d.1 * p.1.01 +
    respvec$y1.cy2.cy3/TIn$p100 * d.1 * p.1.00 +
    respvec$y1.cy2.y3/TIn$p101 * d.1 * p.1.01  
  ...
  dl.dF2 <- respvec$y1.y2.y3/TIn$p111 * d.2 * p.2.11 + 
    ...
    respvec$cy1.y2.y3/TIn$p011 * d.2 * p.2.01 +
    respvec$cy1.y2.cy3/TIn$p010 * d.2 * p.2.00 -
    respvec$cy1.cy2.cy3/TIn$p000 * d.2 * p.2.00 -
    respvec$cy1.cy2.y3/TIn$p001 * d.2 * p.2.01 -
  ...
  dl.dF3 <-  respvec$y1.y2.y3/TIn$p111 * d.3 * p.3.11 -
    ...
    respvec$cy1.y2.y3/TIn$p011 * d.3 * p.3.01 -
    respvec$cy1.y2.cy3/TIn$p010 * d.3 * p.3.01 -
    respvec$cy1.cy2.cy3/TIn$p000 * d.3 * p.3.00 +
    respvec$cy1.cy2.y3/TIn$p001 * d.3 * p.3.00 -
  ...
  mean.12 <- ( TIn$mar1 * (TIn$theta13 - TIn$theta12 * TIn$theta23) + TIn$mar2 * (TIn$theta23 - TIn$theta12 * TIn$theta13) )/( 1 - TIn$theta12^2 )
  mean.13 <- ( TIn$mar1 * (TIn$theta12 - TIn$theta13 * TIn$theta23) + TIn$mar3 * (TIn$theta23 - TIn$theta12 * TIn$theta13) )/( 1 - TIn$theta13^2 )
  ...
  dl.dtheta12 <- respvec$y1.y2.y3/TIn$p111   * d11.12 * p12.g + 
    ...
    respvec$cy1.y2.y3/TIn$p011 * d11.12 * p12.g - 
    respvec$cy1.y2.cy3/TIn$p010 * d11.12 * p12.g.c + 
    respvec$cy1.cy2.cy3/TIn$p000 * d11.12 * p12.g.c + 
    respvec$cy1.cy2.y3/TIn$p001 * d11.12 * p12.g - 
  ...
  dl.dtheta13 <- respvec$y1.y2.y3/TIn$p111 * d11.13 * p13.g - 
    ...
    respvec$cy1.y2.y3/TIn$p011 * d11.13 * p13.g + 
    respvec$cy1.y2.cy3/TIn$p010 * d11.13 * p13.g + 
    respvec$cy1.cy2.cy3/TIn$p000 * d11.13 * p13.g.c - 
    respvec$cy1.cy2.y3/TIn$p001 * d11.13 * p13.g.c -
  ...
  dl.dtheta23 <- respvec$y1.y2.y3/TIn$p111 * d11.23 * p23.g -
    ...
    respvec$cy1.y2.y3/TIn$p011 * d11.23 * p23.g.c -
    respvec$cy1.y2.cy3/TIn$p010 * d11.23 * p23.g.c +
    respvec$cy1.cy2.cy3/TIn$p000 * d11.23 * p23.g.c -
    respvec$cy1.cy2.y3/TIn$p001 * d11.23 * p23.g.c +
  ...
  # ! #
  ####################################################
  ## In GTRIVec: 3rd, 4th, 9th, 10th lines are new  ##
  ####################################################
