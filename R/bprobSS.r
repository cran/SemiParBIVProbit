bprobSS <- function(params, dat, X1.d2, X2.d2, S=NULL, gam1, gam2, fp, K=NULL, n=NULL, N=NULL, cuid=NULL, uidf=NULL, masses=NULL){
  ...
  d2l.be1.be1  <- -  ( d.n1^2*( A^2*-1/p11 + A.c^2*-1/p10 - 1/d.n1*p0)  )  
